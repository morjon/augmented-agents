from utils.utils import generate, get_rating
...
class Agent:
    ...
    Methods:
        ...
        execute_action(other_agents, location, global_time, town_areas, prompt_meta):
            Executes the agent's action based on their current context and
            interactions with other agents.

        update_memories(other_agents, global_time, action_results):
            Updates the agent's memories based on new interactions with other agents.
        ...
        rate_locations(locations, town_areas, global_time, prompt_meta):
            Rates different locations in the simulated environment based on the agent's
    ...
    def plan(self, global_time, prompt_meta):
        ...
        """
        prompt = """
                 You are {}. The following is your description: {} You just woke up. 
                 What is your goal for today? Write it down in an hourly basis, 
                 starting at {}:00. Write only one or two very short sentences. 
    ...
    def execute_action(
        ...
        """
        Executes the agent's action based on their current situation and
        recorded interactions with other agents.
        ...
        Parameters:
            ...
            town_areas : dict
                A dictionary of Location objects representing different areas in the
        ...
        prompt = """
                 You are {}. Your plans are: {}. You are currently in {} with the 
                 following description: {}. It is currently {}:00. The following people 
                 are in this area: {}. You can interact with them.
                 """.format(
            self.name,
            self.plans,
            location.name,
    ...
    def rate_memories(self, locations, global_time, prompt_meta):
        ...
        Parameters:
            locations : Locations
                The Locations object representing different areas in the
                simulated environment.
        ...
        Returns:
            memory_ratings : list
                A list of tuples representing the memory, its rating, and the
                generated response.
        """
        memory_ratings = []
        for memory in self.memories:
            prompt = """
                     You are {}. Your plans are: {}. You are currently in {}. It is 
                     currently {}:00. You observe the following: {}. Give a rating, 
                     between 1 and 5, to how much you care about this.
                     """.format(
                self.name,
                self.plans,
    ...
    def rate_locations(self, locations, global_time, prompt_meta):
        ...
        Returns:
            place_ratings : list
                A list of tuples representing the location, its rating, and the
                generated response.
        ...
        for location in locations.locations.values():
            prompt = """
                     You are {}. Your plans are: {}. It is currently {}:00. You are 
                     currently at {}. How likely are you to go to {} next?
                     """.format(
                self.name,
                self.plans,
                str(global_time),
